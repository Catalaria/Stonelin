...
/turf/closed/wall/mineral/stone/abyssal
	...
	icon = 	'modular/stonekeep/kaizoku/icons/wallset/spine_alt.dmi'
...
/turf/closed/wall/mineral/stone/abyssal/external
	...
	icon = 	'modular/stonekeep/kaizoku/icons/wallset/spine.dmi'
...
/turf/closed/wall/mineral/wood/abyssal
	...
	icon = 	'modular/stonekeep/kaizoku/icons/wallset/vectorial.dmi'
...
/turf/closed/wall/mineral/wood/fractal
	...
	icon = 	'modular/stonekeep/kaizoku/icons/wallset/fractal.dmi'
...
/turf/closed/wall/mineral/stone/gladiatora
	...
	icon = 	'modular/stonekeep/kaizoku/icons/wallset/gladiatora.dmi'
...
/obj/effect/abyssgate_sensor/Crossed(atom/movable/A) //This entire system will become different later. This is just a proof of concept for mapping until we have demons.
	...
	if(ishuman(L))
		...
		if((islist(H.faction) && ("orcs" in H.faction)) || (H.dna?.species?.id == "tiefling") || (H.mob_biotypes & MOB_UNDEAD))
			to_chat(H, span_danger("The Abyssgate scorches your infernal blood!"))
			H.Immobilize(10)
			H.apply_status_effect(/datum/status_effect/buff/rayoffrost5e/)
			H.adjustFireLoss(5)
			H.Stun(20)
			playsound(master.loc, 'sound/misc/fire_place.ogg', 50, 1)
			return

	to_chat(L, span_notice("A warm sensation washes over you as you cross the gate..."))
	playsound(master.loc, 'sound/misc/fire_place.ogg', 30, 1)
...
/obj/structure/fluff/railing/frontfence/CheckExit(atom/movable/O, turf/target)
...
/obj/structure/fluff/gong/attack_hand(mob/living/user)
	...
	playsound(src.loc, 'sound/items/signalhorn.ogg', 100, TRUE)
	...
	for(var/mob/living/player in GLOB.player_list)
		if(player.stat != DEAD && !isbrain(player) && is_tideseeker(player.mind?.assigned_role))
			player.playsound_local(get_turf(player), 'sound/items/signalhorn.ogg', 60, FALSE)
