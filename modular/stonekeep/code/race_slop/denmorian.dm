/mob/living/carbon/human/species/denmorian
	race = /datum/species/denmorian

/datum/species/denmorian
	name = "Hollow-Kin"
	id = "denmorian"
	desc = "The Denmorian are the unholy amalgamation of beast and man, spawned from Zizonic mana during the struggle with the wretched Warlock. \
	Boasting innumerable variations of beastial features, their integration into society ranges from tremendous successes to horrible failures.\
	\n\n\
...
/datum/species/denmorian/get_hairc_list()
...
/datum/species/denmorian/check_roundstart_eligible()
	return TRUE

/datum/species/denmorian/qualifies_for_rank(rank, list/features)
	return TRUE

/datum/species/denmorian/on_species_gain(mob/living/carbon/foreign, datum/species/old_species)
	..()
	foreign.grant_language(/datum/language/common)
//	languages(foreign)

/*
/datum/species/denmorian/proc/languages(mob/living/carbon/human/foreign)
	if(foreign.skin_tone == SKIN_COLOR_GRENZELHOFT)
		foreign.grant_language(/datum/language/grenzelhoftian)
*/

/datum/species/denmorian/get_skin_list()
	return sortList(list(
