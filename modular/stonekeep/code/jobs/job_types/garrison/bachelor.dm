/datum/job/roguetown/royalguard
	...
	tutorial = "You've been elevated by oathbound merit, granted knighthood under the accolade ritual. \
	As a vassal, your bailiff takes care of your land so you can perform the duty of protecting the suzerain. \
	Greater empires will test your loyalty, probing for cracks to turn you against the crown, but spitting \
	on the plate that feeds you will be your downfall."
